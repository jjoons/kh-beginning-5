...
SELECT * FROM C30_L59044_ANIMAL_INS
    FULL OUTER JOIN C30_L59044_ANIMAL_OUTS ON
        (C30_L59044_ANIMAL_OUTS.ANIMAL_ID = C30_L59044_ANIMAL_INS.ANIMAL_ID)
    WHERE C30_L59044_ANIMAL_OUTS.ANIMAL_ID IS NULL
        OR C30_L59044_ANIMAL_INS.ANIMAL_ID IS NULL
;
